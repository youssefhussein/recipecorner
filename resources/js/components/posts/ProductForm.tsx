...
const cookingTechniques = ['Baking', 'Grilling', 'Sautéing', 'Roasting', 'Steaming', 'Frying', 'Broiling', 'Poaching', 'Simmering', 'Boiling'];
        ...
        <div className="relative">
            ...
            {showResults && (
                <div className="absolute z-10 mt-1 max-h-40 w-full overflow-y-auto rounded-md border bg-white shadow-lg">
                    ...
                    {filteredPosts.filter((post) => post.type === 'recipe').length === 0 && <div className="p-2 text-gray-500">No recipes found</div>}
                </div>
            )}
        </div>
    );
